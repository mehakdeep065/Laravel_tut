...
<body class="overflow-x-clip">
    <div
        class="bg-[url('images/man-camping-in-nature-and-watching-stars-picjumbo-com.jpg')] bg-cover bg-center h-screen w-full text-white  ">
        <main>
            <x-head_foot contClass="text-white" />
            <x-hero />
            <x-contant1 />
            <x-card />
            <div>
                <h3 class="text-black flex justify-center py-10 text-3xl font-bold">Top Things to do in parks</h3>
            ...
            <x-head_foot contClass="text-black py-30" />
        </main>
    </div>
</body>
